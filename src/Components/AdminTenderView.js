	...
	render() {
		return (
			<div className='adminVehicleProfile'>
				<NavBar_home />
				<br /> <h3 align='center'>Tender Managment</h3>
				<div className='row-frm'>
				<button><Link to={"/Hotelregister"} className="btn btn-success">Add Tender</Link></button>
					<table className='table table-striped' style={{ marginTop: 20 }}>
						<thead>
							<tr>
								...
								<th>Email Address</th>
								<th>Date </th>
								<th>Project Basic Infromation</th>
                                

								<th colSpan='3'>Manage details</th>
							</tr>
						</thead>
